		...
		<div class="col-md-12">
			<form action="userInsert.do"  method="post" class="form-horizontal" enctype="multipart/form-data"  >
				...
				<div class="form-group form-inline">
					<label class="col-sm-3 control-label" for="user_id">원아 식별코드</label>
					<div class="col-sm-6">
				...
				<div class="form-group form-inline">
					<label class="col-sm-3 control-label" for="user_name">소속어린이집/유치원</label>
					<div class="col-sm-6">
						<input class="form-control" id="user_name" name="user_name" type="text">
					</div>
				</div>
				...
				<div class="form-group form-inline">
					<label class="col-sm-3 control-label" for="user_name">원아 소속반</label>
					<div class="col-sm-6">
						<input class="form-control" id="user_name" name="user_name" type="text">
					</div>
				</div>
