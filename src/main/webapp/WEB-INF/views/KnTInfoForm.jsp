					...
					<div class="container">
						<form action="userupadate.do" method="post"
							...
							<div class="form-group form-inline">
								<label class="col-sm-3 control-label" for="user_profile">프로필사진등록</label>
								<div class="filebox col-sm-6">
									<label for="user_profile">업로드</label> <input
										class="form-control" type="file" name="user_profile"
										id="user_profile">
								</div>
								<!-- image src 는 실제 올린 url 가져다가 뿌려줄 것 -->
								<input type="image" src="images/client-face2.png">
							</div>
							...
							<div class="form-group form-inline">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control " id="user_id"
										name="user_id" placeholder="schoolcode">
