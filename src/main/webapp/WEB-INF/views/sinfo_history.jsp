			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="sinfo_history.do"><i class="fa fa-angle-right" aria-hidden="true"></i>연혁</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							...
							<li class="active"><a href="sinfo_history.do"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>연혁</a></li>
				...
				<div class="main_content">
					...
					<div class="products_iso">
						<div class="row">
							<div class="col">
								<img alt="" src="images/sinfo_history.png">
							</div>
						</div>
					</div>
				</div>
