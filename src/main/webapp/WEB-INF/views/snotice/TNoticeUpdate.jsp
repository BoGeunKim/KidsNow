			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="TNoticeUpdate.do"><i class="fa fa-angle-right" aria-hidden="true"></i>선생님 공지사항 수정</a></li>
					</ul>
				</div>
				...
				<div class="main_content">
					...
					<table class="table table-bordered">
                       <tr>
                          <th>제목</th>
                          <td><input type="text" value="6월 유치원 소방 점검 사전 대비 안내" class="form-control"></td>
                       </tr>
                        <tr>
                          <th>내용</th>
