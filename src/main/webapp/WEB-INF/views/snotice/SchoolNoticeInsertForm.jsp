...
<html>
<head>
<title>SchoolNoticeInsertForm.jsp</title>
<meta charset="UTF-8">
	...
	<div class="container product_section_container">
		<div class="row">
			<div class="col product_section clearfix">
				...
				<!-- 현 위치 -->
				<div class="breadcrumbs d-	lex flex-row align-items-center">
					<ul>
						<li><a href="SchoolNotice.do">유치원 소식</a></li>
						<li class="active"><a href="SchoolNotice.do"><i class="fa fa-angle-right" aria-hidden="true"></i>공지사항 작성</a></li>
					</ul>
				</div>
				...
				<div class="main_content">
					...
					<table class="table table-bordered">
                       <tr>
                        ...
                        <tr>
                          <th>내용</th>
                          <td><textarea placeholder="내용을 입력하세요" style="height: 200px;" class="form-control"></textarea></td>
                       </tr>
                        <tr>
                          <th>첨부파일</th>
