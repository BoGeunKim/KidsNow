...
<html>
<head>
<title>SchoolNoticeContent.jsp</title>
<meta charset="UTF-8">
			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="SchoolNoticeContent.do"><i class="fa fa-angle-right" aria-hidden="true"></i>공지사항 본문</a></li>
					</ul>
				</div>
				...
				<div class="main_content">
					...
					<table class="table table-bordered">
                       <tr>
                        ...
                        <tr>
                          <th>내용</th>
                          <td style="height: 200px;">5월 5,6,7,8 연휴입니다. 등원하지 마세요.</td>
                       </tr>
                        <tr>	
                          <th>첨부파일</th>
					...
					<div style="margin-left: 69%;">
						...
						<button class="btn btn-primary btn-xs" onclick="location.href='SchoolNoticeUpdate.do'">수정&nbsp;<i class="fa fa-pencil"></i></button>
