...
<html>
<head>
<title>SinfoCondition.jsp</title>
<meta charset="UTF-8">
			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="SinfoCondition.do"><i class="fa fa-angle-right" aria-hidden="true"></i>유치원 현황</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							...
							<li class="active"><a href="SinfoCondition.do"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>유치원 현황</a></li>
