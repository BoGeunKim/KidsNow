            ...
            <div class="container slider-content">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
                        <h2>KIDS<span style="color: red">NOW</span></h2>
                ...
                <div class="row how-it-work text-center">
                    <div class="col-md-4">
                        <div class="single-work wow fadeInUp" data-wow-delay="0.8s">
                            <img src="images/how-work1.png" alt="">
                      ...
                      <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="employeers">
                            <ul class="list-inline">
                                <li>
                                    <a href="">
                                        <img src="images/employee4.png" alt="">
                                ...
                                <li>
                                    <a href="">
                                        <img src="images/employee3.png" alt="">
                        ...
                        <div class="job-posts table-responsive">
                            <table class="table">
                                <tr class="odd wow fadeInUp" data-wow-delay="1s">
                                    <td class="tbl-logo"><img src="images/job-logo1.png" alt=""></td>
                                ...
                                <tr class="even wow fadeInUp" data-wow-delay="1.1s">
                                    <td class="tbl-logo"><img src="images/job-logo2.png" alt=""></td>
                                ...
                                <tr class="odd wow fadeInUp" data-wow-delay="1.2s">
                                    <td class="tbl-logo"><img src="images/job-logo3.png" alt=""></td>
                                ...
                                <tr class="even wow fadeInUp" data-wow-delay="1.3s">
                                    <td class="tbl-logo"><img src="images/job-logo4.png" alt=""></td>
                                ...
                                <tr class="odd wow fadeInUp" data-wow-delay="1.4s">
                                    <td class="tbl-logo"><img src="images/job-logo5.png" alt=""></td>
                        ...
                        <div id="testimonial-slider">
                            <div class="item">
                                ...
                                <div class="client-face wow fadeInRight" data-wow-delay=".9s"> 
                                    <img src="images/client-face1.png" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-text">                                
                                ...
                                <div class="client-face">
                                    <img src="images/client-face2.png" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-text">                                
                ...
                <div class="row footer">
                    <div class="col-md-4">
                        <div class="single-footer">
                            <img src="images/footer-logo.png" alt="" class="wow pulse" data-wow-delay="1s">
